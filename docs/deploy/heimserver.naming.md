...
Semantik:
    •   Weltgewebe Services (getrennter Stack)
    •   Keine Überlappung mit Heimgewebe
...
Keine Kreuz-Referenzen (Heimgewebe-Host in Weltgewebe-Zone).
...
https://weltgewebe.home.arpa {
  reverse_proxy weltgewebe-stack:8080
  tls internal
}
```
...
Pi-hole `/etc/dnsmasq.d/99-weltgewebe.conf` (nur bei Bedarf):
...
| Heimgewebe-Host im Weltgewebe-Stack | Semantischer Bruch |
